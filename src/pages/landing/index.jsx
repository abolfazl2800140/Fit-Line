    ...
    <div className="flex flex-col h-screen w-screen">
      <nav className="flex-1/12 flex justify-between items-center bg-[#0097a0] p-1">
        <div className="flex justify-center gap-3 items-center ">
          <span className="text-white text-lg">ورود</span>
          <span className="text-white  text-lg">ثبت نام</span>
        </div>
        <div>
      ...
      <div className="flex-11/12 bg-[#88d9dd] flex items-center">
        <div className=" h-[70%] mx-auto flex flex-col items-center gap-24">
          ...
          <div className="text-white text-xl bg-[#f48b37] w-32 h-16 flex justify-center items-center rounded-2xl ">
            جستجوی مربی
          </div>
          <div className="absolute bottom-50 right-10 w-32 h-48 flex rotate-45">
            <div className="h-14 w-5 bg-[#0097a0] rounded-2xl self-center"></div>
            <div className="w-14 h-5 bg-[#06bdc7]  self-center"></div>
            <div className="h-14 w-5 bg-[#0097a0] rounded-2xl self-center"></div>
          </div>
        </div>
      </div>
